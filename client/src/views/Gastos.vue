<template>
  <div class="container">
    <h1 class="title h1 bold mb3">Despesas de Gabinete</h1>
    <table v-if="despesasState !== null" class="mx-auto">
      ...
      <tr v-for="(deputado, index) in despesasState.data.deputadosDespesasArray" :key="index">
        <td>{{ index + 1 }}</td>
        <td>
          <router-link :to="'/deputado/'+deputado._id" tag="a">{{ deputado.deputadoName }}</router-link>
        </td>
